...
Transmission.prototype =
{
	...
	****/
	...
	renameSelectedTorrents: function() {
		var torrents = this.getSelectedTorrents();
		if (torrents.length != 1)
			dialog.alert("Переименование", "Вы можете переименовать только один торрент за раз.", "Ок");
		else
	...
	***/
	...
	updateGuiFromSession: function(o)
	{
		...
		if (RPC._TurtleState in o)
		{
			...
			e = $('#turtle-button');
			text = [ 'Нажмите для ', (b?'выключения':'включения'),
			         ' времнного ограничения скорости (',
